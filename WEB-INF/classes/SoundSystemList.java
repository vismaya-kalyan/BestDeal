...
public class SoundSystemList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, SoundSystem> allSoundSystem = new HashMap<String, SoundSystem>();
        /* Checks the Tablets type whether it is microsft or sony or nintendo */
        try {
            allSoundSystem = MySqlDataStoreUtilities.getSoundSystem();
            System.out.println("allSoundSystem:" + allSoundSystem);
        } catch (Exception e) {

        }

        if (CategoryName == null) {
            hm.putAll(allSoundSystem);
            name = "";
        } else {
            if (CategoryName.equals("sony")) {
                for (Map.Entry<String, SoundSystem> entry : allSoundSystem.entrySet()) {
