...
public class FitnessWatchList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, FitnessWatch> allFitnessWatch = new HashMap<String, FitnessWatch>();

        try {
            allFitnessWatch = MySqlDataStoreUtilities.getFitnessWatchs();
            System.out.println("allFitnessWatch" + allFitnessWatch);
        } catch (Exception e) {

        }
        if (CategoryName == null) {
            hm.putAll(allFitnessWatch);
            name = "";
        } else {
            if (CategoryName.equals("fitbit")) {
                for (Map.Entry<String, FitnessWatch> entry : allFitnessWatch.entrySet()) {
