...
public class TvList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, Tv> allTv = new HashMap<String, Tv>();
        /* Checks the Tablets type whether it is microsft or sony or nintendo */

        try {
            allTv = MySqlDataStoreUtilities.getTvs();
            System.out.println("allTv" + allTv);
        } catch (Exception e) {
        ...
        if (CategoryName == null) {
            ...
            if (CategoryName.equals("sony")) {
                for (Map.Entry<String, Tv> entry : allTv.entrySet()) {
        ...
        for (Map.Entry<String, Tv> entry : hm.entrySet()) {
            ...
            pw.print("<li><form method='post' action='WriteReview'>" + "<input type='hidden' name='name' value='"
                    ...
                    + tv.getPrice() + "'>" + "<input type='submit' value='WriteReview' class='btnreview'></form></li>");
