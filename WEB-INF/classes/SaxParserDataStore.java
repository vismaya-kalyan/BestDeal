...
public class SaxParserDataStore extends DefaultHandler {
	...
	public SaxParserDataStore(String consoleXmlFileName) {
		...
		parseDocument();
		System.out.println();
		System.out.println("READING FROM  ProductCatalog.xml TO HashMap");
		System.out.println();
		System.out.println("TV: " + tvs);
		System.out.println();
		System.out.println("SOUND SYSTEMS: " + soundsystems);
		System.out.println();
		System.out.println("PHONES: " + phones);
		System.out.println();
		System.out.println("LAPTOPS: " + laptops);
		System.out.println();
		System.out.println("VOICE ASSISTANT: " + voiceassistants);
		System.out.println();
		System.out.println("FITNESS WATCHES: " + fitnesswatchs);
		System.out.println();
		System.out.println("SMART WATCHES: " + smartwatchs);
		System.out.println();
		System.out.println("HEADPHONES: " + headphones);
		System.out.println();
		System.out.println("WIRELESS PLANS: " + wirelessplans);
		System.out.println();
	...
	public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if (element.equals("accessory") && currentElement.equals("accessory")) {
			...
			// System.out.println("accessories SAX PARSER" + accessories);
			return;
		}
		...
		if (element.equalsIgnoreCase("sale")) {
			if (currentElement.equals("tv"))
				tv.setSale(elementValueRead);
			if (currentElement.equals("soundsystem"))
				soundsystem.setSale(elementValueRead);
			if (currentElement.equals("phone"))
				phone.setSale(elementValueRead);
			if (currentElement.equals("laptop"))
				laptop.setSale(elementValueRead);
			if (currentElement.equals("voiceassistant"))
				voiceassistant.setSale(elementValueRead);
			if (currentElement.equals("fitnesswatch"))
				fitnesswatch.setSale(elementValueRead);
			if (currentElement.equals("smartwatch"))
				smartwatch.setSale(elementValueRead);
			if (currentElement.equals("headphone"))
				headphone.setSale(elementValueRead);
			if (currentElement.equals("wirelessplan"))
				wirelessplan.setSale(elementValueRead);
			if (currentElement.equals("accessory"))
