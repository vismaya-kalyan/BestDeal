...
public class SalesReport extends HttpServlet {
    ...
    private void displaySalesReport(HttpServletRequest request, HttpServletResponse response, PrintWriter pw)
            throws ServletException, IOException {
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
            ...
            pw.print("<tr>");
            pw.print("<td>" + orderPayment.getOrderName() + "</td>" + "<td>" + orderPayment.getOrderPrice() + "</td>"
        ...
        // Bar Chart of that shows the product names and the total sales for every
        // product
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
            ...
            pw.print("<tr>");
            pw.print("<td>" + orderTime + "</td>" + "<td>" + orderPayment.getSaleAmount() + "</td>");
            pw.print("</tr>");
