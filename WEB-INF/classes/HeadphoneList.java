...
public class HeadphoneList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, Headphone> allHeadphone = new HashMap<String, Headphone>();

        try {
            allHeadphone = MySqlDataStoreUtilities.getHeadphones();
            System.out.println("allHeadphone" + allHeadphone);
        } catch (Exception e) {
            System.out.println(e);
        }
        if (CategoryName == null) {
            hm.putAll(allHeadphone);
            name = "";
        } else {
            if (CategoryName.equals("jbl")) {
                for (Map.Entry<String, Headphone> entry : allHeadphone.entrySet()) {
