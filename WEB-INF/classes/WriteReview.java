...
public class WriteReview extends HttpServlet {
    ...
    protected void review(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pw.print("</h2><div class='entry'><form name ='WriteReview' action='SubmitReview' method='post'>");
            pw.print("<table class='gridtable'>");
            // 1
            pw.print("<tr><td>ProductModelName: </td><td>");
            ...
            pw.print("<tr>");
            pw.print("<td> ManufacturerName: </td><td> ");
            ...
            pw.print("<td> <input type='text' name='ManufacturerRebate'></td>");
            pw.print("</tr>");
            ...
            // 15
            pw.print("<tr><td> Review Rating: </td><td>");
