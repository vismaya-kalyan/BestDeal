...
public class SmartWatchList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, SmartWatch> allSmartWatch = new HashMap<String, SmartWatch>();
        /* Checks the Tablets type whether it is microsft or sony or nintendo */

        try {
            allSmartWatch = MySqlDataStoreUtilities.getSmartWatchs();
            System.out.println("allSmartWatch" + allSmartWatch);
        } catch (Exception e) {
            System.out.println(e);
        }

        if (CategoryName == null) {
            hm.putAll(allSmartWatch);
            name = "";
        } else {
            if (CategoryName.equals("apple")) {
                for (Map.Entry<String, SmartWatch> entry : allSmartWatch.entrySet()) {
